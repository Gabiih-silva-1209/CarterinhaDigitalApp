...
import com.senai.carterinhadigital.core.designsystem.feature.components.presentation.PerfilAluno
...
fun CarteirinhaContentPreviewClaro() {
    CarteirinhaDigitalApp(darkTheme = false) {
        CarteirinhaContent()
    }
}
...
fun CarteirinhaContentPreviewEscuro() {
    CarteirinhaDigitalApp(darkTheme = true) {
        CarteirinhaContent()
    }
}